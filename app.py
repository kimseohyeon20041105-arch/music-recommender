...
.cute-box {padding: 12px 16px; border-radius: 15px; font-size: 16px; line-height:1.5;}
.colored-box {background-color: #D9F1FF;}
.title-text {font-size:18px; font-weight:600;}
.title-main {font-size:28px; font-weight:700; background:linear-gradient(90deg,#6EE888,#9EFFA4,#C9FFC8); -webkit-background-clip:text; color:transparent; text-align:center;}
.divider-text {font-size:13px; color:#777;}
</style>
...
<div class="cute-box">
    ...
    선택한 감정과 인기도(pop_level)를 기반으로 영어 음악을 추천합니다.
</div>
""", unsafe_allow_html=True)
...
with result_container:
    ...
    <div style="display:flex; align-items:center; margin:10px 0;">
        ...
        <div class="divider-text" style="padding:0 10px;">✦⋆˙✧₊˚༉‧₊˚⋆⁺₊⋆✧˙⋆✦</div>
        <div style="flex-grow:1; height:1px; background:#ccc;"></div>
    </div>
    """, unsafe_allow_html=True)
    ...
    if st.button("피드백 제출"):
        ...
        st.success("피드백이 반영되었어요! 더 나은 추천을 받을 수 있습니다.")
```
